...
class BluetoothMeshServiceDeliveryTest {
    ...
    @Test
    fun queuedMessagesSentAfterServiceDiscovery() = runBlocking {
        ...
        assertEquals(1, queues[peerId]?.size)
        ...
        val queueAfter = queues[peerId]
        assertTrue(queueAfter == null || queueAfter.isEmpty())
